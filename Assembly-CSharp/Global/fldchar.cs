	...
	public static void FF9FieldCharDispatch(Int32 uid, Int32 Parm, Int32 Arg1, Int32 Arg2, Int32 Arg3)
	{
		...
		case 11:
		{
			...
			if (ff9FieldCharMirror == null)
			{
			    ...
			    Shader shader = ShadersLoader.Find(Configuration.Graphics.CustomShader == 1 ? "FieldMapActor_RealLighting" : "PSX/FieldMapActor");
				...
				if (charStateArray.ContainsKey(key))
				{
					...
					if (ff9Char.geo)
					{
						...
						if (flag)
						{
							...
							{
							    Shader shader2 = ShadersLoader.Find(Configuration.Graphics.CustomShader == 1 ? "FieldMapActor_RealLighting" : "PSX/FieldMapActor");
