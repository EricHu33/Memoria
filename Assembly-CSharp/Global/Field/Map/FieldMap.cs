    ...
    public void AddPlayer()
    {
        ...
        else
        {
            ...
            for (Int32 j = 0; j < componentsInChildren2.Length; j++)
            {
                ...
                renderer2.material.shader = ShadersLoader.Find(Configuration.Graphics.CustomShader == 1 ? "FieldMapActor_RealLighting" : "PSX/FieldMapActor");
            }
        }
    }
        ...
        else
        {
            ...
            else
            {
                ...
                for (Int32 i = 0; i < renderers.Length; i++)
                {
                    Material[] materials = renderers[i].materials;
                    for (Int32 j = 0; j < materials.Length; j++)
                        materials[j].shader = ShadersLoader.Find(Configuration.Graphics.CustomShader == 1 ? "FieldMapActor_RealLighting" : "PSX/FieldMapActor");
                }
            }
        }
